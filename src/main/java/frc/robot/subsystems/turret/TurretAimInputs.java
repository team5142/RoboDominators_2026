...
public class TurretAimInputs {
  ...
  public double robotOmegaRadPerSecond = 0.0;
  ...
  // True for one cycle after the pose estimator is reseeded — tells the solver to drop its latch.
  public boolean poseReseeded = false;
}
