...
// Safety auto — no movement, no shooting. Seeds pose to the left ShootInPlace position.
...
public class DoNothingLeftAuto extends SequentialCommandGroup {
  ...
  public DoNothingLeftAuto(
    ...
    addCommands(
        // Seed pose to the left ShootInPlace position — flipped for Red automatically
        Commands.runOnce(() -> {
