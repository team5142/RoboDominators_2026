...
// Prototype command for looping intake sweeps through the alliance zone.
// Path points are placeholders and should be updated once geometry is finalized.
public class AllianceZoneIntakeSweepCommand extends Command {
  ...
  public AllianceZoneIntakeSweepCommand(
  ...
  public void initialize() {
    sweepLoop = buildSweepLoop(config); // Build lane targets for the alliance zone.
  ...
  public void end(boolean interrupted) {
    ...
    SmartLogger.logReplay("AllianceSweep/Interrupted", interrupted);
  }
  ...
  private void startNextSegment() {
    ...
    SmartLogger.logReplay("AllianceSweep/TargetPose", targetPose);
  }
